...
<div class="flex min-h-screen items-center justify-center bg-gray-100 font-inter">
	<div class="w-full max-w-xl rounded-lg bg-white p-16 shadow-md">
		<form method="post" action="?/login" use:enhance class="space-y-4">
			...
			<div class="mt-5 flex items-center justify-between">
				<button
					type="submit"
					class="w-full rounded-md bg-primary px-4 py-2 font-medium text-white shadow-md transition duration-200 hover:bg-primary-dark"
				>
					Login
				</button>
			</div>
